...
oh-my-posh init pwsh --config 'C:/Users/PC/Documents/powershell/clean-detailed.omp.json' | Invoke-Expression
#oh-my-posh init pwsh --config 'C:/Users/PC/Documents/powershell/myprofile1.omp.json' | Invoke-Expression 
